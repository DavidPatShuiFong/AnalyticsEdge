...
Perhaps population growth is exponential, but the rate of exponential growth is changing with time e.g. declining due to demographic transition [@vriesSustainabilityScience2013]. If, within the timeframe of the data, the rate of exponential growth change is locally linear, this can be modeled:
...
Unable to predict if www.worldometers.info will change their model over the next few weeks to deal with unexpected influences on population, e.g. COVID-19 [@roser2020owid]!
